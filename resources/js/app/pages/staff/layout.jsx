...
const navigation = [
    { name: "Dashboard", href: "/staff/dashboard", icon: HomeIcon, current: false },
    {
...
const teams = [
    {
        ...
        current: false,
        children: [
            { name: "Accounts List", href: "/staff/accounts", icon: FaRegCircleDot },
        ],
    },
    {
        id: 2,
        ...
        current: false,
        children: [
            { name: "Room Section", href: "/staff/rooms", icon: FaRegCircleDot },
            {
    ...
    },
    {
        ...
        children: [
            ...
            //     icon: FaRegCircleDot,
            // },
            { name: "Contact Us", href: "/staff/contact", icon: FaRegCircleDot },
        ],
    },
];
