        ...
        <nav aria-label="Global" className="mx-auto flex max-w-8xl items-center justify-between p-6 lg:px-8">
          <div className="flex lg:flex-1">
            ...
            <span className="sr-only">Blue Waves Resort</span>
              ...
              <h3 className='text-lg font-medium'>Blue Waves Resort</h3>
              <p className='text-gray-600 text-xs font-medium italic'>Brgy. Ermita, Sipaway Island, San Carlos City</p>
              </div>
                </div>
            </a>
          </div>
