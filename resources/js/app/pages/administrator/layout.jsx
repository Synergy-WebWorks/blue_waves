...
const navigation = [
    { name: "Dashboard", href: "/administrator/dashboard", icon: HomeIcon, current: false },
    {
        ...
        href: "/administrator/reservation",
...
const teams = [
    {
        ...
        current: false,
        children: [
            { name: "Accounts List", href: "/administrator/accounts", icon: FaRegCircleDot },
        ],
    },
    {
        id: 2,
        ...
        current: false,
        children: [
            { name: "Room Section", href: "/administrator/rooms", icon: FaRegCircleDot },
            {
                name: "Cottage Section",
                href: "/administrator/cottage",
                icon: FaRegCircleDot,
            },
            {
            ...
            },
            {
                ...
                href: "/administrator/terms",
                icon: FaRegCircleDot,
            },
            // {
            //     name: "Landing Page Section",
            //     href: "/administrator/landing-page",
            //     icon: FaRegCircleDot,
            // },
        ],
    },
