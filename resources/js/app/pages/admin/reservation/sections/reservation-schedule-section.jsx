...
export default function ReservationScheduleSection() {
  return (
    <div className="md:grid md:grid-cols-2 md:divide-x md:divide-gray-200">
      <div className="md:pr-14">
        <div className="flex items-center">
          <h2 className="flex-auto text-sm font-semibold text-gray-900">January 2024</h2>
          <button
            type="button"
                ...
                >
                  <div className="py-1">
                    <Menu.Item>
                      <Link
                        href="#"
                        className="block px-4 py-2 text-sm text-gray-700 data-focus:bg-gray-100 data-focus:text-gray-900 hover:bg-gray-100"
                      >
                        View Details
                      </Link>
                    </Menu.Item>
