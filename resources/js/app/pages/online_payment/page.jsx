...
const OnlinePaymentPage = () => {
    ...
    useEffect(() => {
        store.dispatch(get_booking_info_by_id_thunk(reference_id));
    }, []);
    ...
    useEffect(() => {
        setAmount(booking_info.initial);
    ...
    const payWithCard = async (event) => {
        ...
        await Xendit.card.createToken(
            {
                amount: amount,
                card_holder_first_name: "marlou",
                card_holder_last_name: "pepito",
                card_holder_phone_number: "+639208868123",
            ...
            case "VERIFIED":
                ...
                axios
                    .post("/api/pay-with-card", {
                        ...
                        amount: amount,
                        billing_details: {
                            given_names: `${booking_info.fname}`,
                            surname: `${booking_info.lname}`,
                            email: booking_info.email,
                            mobile_number: booking_info.mobile,
                            phone_number: booking_info.mobile,
                            address: {
                                street_line1: booking_info.address,
                                street_line2: "sipaway island",
                                city: "San Carlos City",
                                province_state: "Negros Occidental",
                                postal_code: "6127",
                                country: "PH",
                            },
                        },
