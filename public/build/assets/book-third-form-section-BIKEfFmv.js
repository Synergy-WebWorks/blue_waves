...
By confirming your booking and staying at Blue Waves Resort, you agree to abide by these Terms and Conditions.
                                                    ...
                                                    `}),e.jsx("div",{className:"mt-6 flex",children:e.jsxs("label",{className:"flex items-center space-x-2",children:[e.jsx("input",{required:!0,onChange:s=>o(s.target.checked),type:"checkbox",className:"w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring focus:ring-blue-500"}),e.jsxs("span",{className:"text-gray-700",children:["By proceeding, you agree to the"," ",e.jsx("a",{href:"#",className:"text-blue-600 hover:underline",children:"Terms and Conditions"})," ","of Blue Waves Resort."]})]})})]})})]})]})})}export{f as default};
